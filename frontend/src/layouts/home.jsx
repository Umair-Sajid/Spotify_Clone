        ...
        <div className="nav w-full h-16 bg-black bg-opacity-50 flex items-center justify-end">
          <div className="w-1/2  flex h-full">
            ...
            <div className="w-2/5 flex justify-around h-full items-center">
              ...
              <Link
                to={"/signup"}
                className=" text-white h-1/2 px-4 flex items-center justify-center rounded-full font-semibold cursor-pointer hover:bg-gray-500"
              >
                Sign Up
              </Link>
              <Link
                to={"/login"}
                className=" bg-white h-1/2 px-4 flex items-center justify-center rounded-full font-semibold cursor-pointer hover:bg-gray-500"
              >
                Log in
              </Link>
            </div>
